...
public class HostnameResolutionTest extends VertxTestBase {
  ...
  public void testParseResolvConf() {
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("\noptions ndots: 4"));
    assertEquals(-1, DnsNameResolverBuilder.parseNdotsFromResolvConf("boptions ndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf(" options ndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("\toptions ndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("\foptions ndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("\n options ndots: 4"));

    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options\tndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options\fndots: 4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options  ndots: 4"));
    assertEquals(-1, DnsNameResolverBuilder.parseNdotsFromResolvConf("options\nndots: 4"));

    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:\t4"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:  4"));
    assertEquals(-1, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:\n4"));

    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4 "));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4\t"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4\f"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4\n"));
    assertEquals(4, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4\r"));
    assertEquals(-1, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4_"));

    assertEquals(2, DnsNameResolverBuilder.parseNdotsFromResolvConf("options ndots:4\noptions ndots:2"));
  }
}
